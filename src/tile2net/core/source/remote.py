...
from tile2net.core.source.name2base import _Name2Base
from tile2net.core.source.name2prototype import Name2Prototype, _Name2Prototype
from tile2net.core.source.prototype import Prototype
from tile2net.core.source.remote2coverage import Remote2Coverage
...
class Remote(
    ...
    def download_one(self) -> pd.Series:
        ...
        with grid.file._static_peek():
            ...
            try:
                ...
                if 'BrokenThreadPool' in e.__class__.__name__:
                    msg = (
                        f"Thread pool initialization failed. "
                        f"Check logs above for the actual error. "
                        f"Original error: {e}"
                    )
    ...
    def _init_net_worker(self) -> None:
        ...
        try:
            ...
            logger.error(
                f"Failed to initialize network worker thread: {e.__class__.__name__}: {e}",
                exc_info=True
            )
            raise
...
#     from tile2net.core.source.arcgis import *
#     from tile2net.core.source.misc import *
#     from tile2net.core.source.vexcel import *
#
